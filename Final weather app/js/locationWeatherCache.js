...
function getWeather(lat,long, ind){
            ...
            jQuery.getJSON(url + apiKey + "/" + lati + "," + longi + "?callback=?", function(weatherData) {
              ...
              retrievedObject[ind].windSpeed = weatherData.daily.data[ind].windSpeed;
              retrievedObject[ind].humidity = weatherData.daily.data[ind].humidity;
 ...
 //Manually make the temp into SI!
              ...
              retrievedObject[ind].humidity = (retrievedObject[ind].humidity) * (100);
...
//To fixed loop _max
 ...
 // Main statement for displaying Favourites output
    ...
    document.getElementById(idnameforweathersummary).innerHTML = "Summary: " + retrievedObject[ind].summary + " ,Min Temp(C): " +  retrievedObject[ind].temperatureMin + " ,Max Temp(C): " +  retrievedObject[ind].temperatureMax + " Wind Speed (Km/s): " + retrievedObject[ind].windSpeed + " humidity (%): " + retrievedObject[ind].humidity; 
