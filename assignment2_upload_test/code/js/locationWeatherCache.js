...
// locations previously accepted and stored by AddLocation.html and Map.js
{
  ...
  var i;
  weatherTextStringGlob = '';     //global as is defined here but populated + printed by "getWeather" function
  ...
  var  locationObject = { 
    ...
    //retrievedObject.push(locationObject);
     //console.log('Printing retrieved obj 4 is ', retrievedObject);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ...
            retrievedObject[ind].temperatureMax = temp_2;        
             ...
             weatherTextStringGlob += "Location:" +  retrievedObject[ind].address + "     Nickname:" +  retrievedObject[ind].nickname + "     Summary:" + retrievedObject[ind].summary + "     Min Temp:" + retrievedObject[ind].temperatureMin + "     Max Temp:"  +  retrievedObject[ind].temperatureMax +  "<br>" ;
                };
...
// localStorage.getItemtItem('place');
//}
